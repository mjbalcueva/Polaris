...
namespace Polaris.Forms.Subjects
{
    public partial class AVInput : Form
    {
        ...
        #region Events
        private void outOfLabel_MouseDown(object sender, MouseEventArgs e)
        {
            mouseDown = true;
        }

        private void outOfLabel_MouseMove(object sender, MouseEventArgs e)
        {
            if (mouseDown)
            Location = new Point(Cursor.Position.X - 300, Cursor.Position.Y - 15);
        }

        private void outOfLabel_MouseUp(object sender, MouseEventArgs e)
        {
            mouseDown = false;
        }
