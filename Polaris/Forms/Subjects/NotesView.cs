    ...
    public partial class NotesView : Form
    {
        ...
        private void GetData(int subjectID)
        {
            ...
            while (dataReader.Read())
            {
                ...
                AddRecord(id, note_title, note_description, createdDate, modifiedDate);
            }

            connection.Close();
        }

        internal void AddRecord(string id, string title, string description, string created, string modified)
        {
